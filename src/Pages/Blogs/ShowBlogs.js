...
const ShowBlogs = ({bloG}) => {
    return (
        <div>
            <div className=''>
                <img className="w-full rounded-t-lg object-cover h-52" src={bloG?.image} alt="computer" />
                ...
                <div className="bg-white px-4 text-justify py-6 shadow-lg rounded-bl-3xl rounded-br-3xl">
                    ...
                    <div className="w-full mt-4 justify-end flex items-center cursor-pointer p-5">
