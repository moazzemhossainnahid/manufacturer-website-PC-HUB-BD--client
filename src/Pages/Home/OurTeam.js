...
const OurTeam = () => {
    return (
        <div>
            <div className="container flex justify-center mx-auto py-16">
                <div>
                <h1 tabIndex={0} className="text-3xl lg:text-5xl font-bold py-12 leading-0 text-center text-gray-800">
