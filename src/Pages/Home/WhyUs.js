          ...
          <div className="mt-6 md:mt-10 grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 lg:mt-6 2xl:mt-12">
            <div className="flex items-center">
              ...
              <div className="flex items-start flex-col ml-6 pt-8">
                ...
                <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">We Are Very Punctual for any Service.</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="w-16 h-16 relative">
              ...
              <div className="flex items-start flex-col ml-6 pt-8">
                ...
                <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">We Behave Friendly with our Customets.</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="w-16 h-16 relative">
              ...
              <div className="flex items-start flex-col ml-6 pt-8">
                ...
                <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">We Make Unique Product.</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="w-16 h-16 relative">
              ...
              <div className="flex items-start flex-col ml-6 pt-8">
                ...
                <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">We Achive many Certificate.</p>
              </div>
            </div>
          </div>
        </div>
